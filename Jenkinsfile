node {
  stage ('SonarQube Code Analysis') {
    ...
    withSonarQubeEnv('sonarqube') {
      sh '''/var/lib/jenkins/tools/hudson.plugins.sonar.SonarRunnerInstallation/sonarqube/bin/sonar-scanner -Dsonar.host.url=http://34.126.117.238:9000 -Dsonar.login=sonarlogin -Dsonar.projectKey=NodeBank -Dsonar.source=.
'''
    }
  }
